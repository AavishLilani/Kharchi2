                ...
                <form action="#" className='flex flex-col gap-3 w-full items-center p-10 bg-black border border-gray-500 box-md mb-5 shadow-sm '>
                    ...
                    < div className={`${type === "login" ? "hidden" : "block"}`}>
                        ...
                        <div className='flex items-center my-4 w-full'>
                            ...
                            <hr className='w-full border-t border-gray-300' /></div>
                    </div>
                    < div className='flex flex-col gap-5 items-center '>

                        <div> <input type="text" placeholder='Name' className={`${type === "login" ? "hidden" : "block p-2 border border-grey-500 rounded-md bg-black"}`} /></div>
                        <div><input type='email' placeholder='Email' className='p-2 border border-grey-500 rounded-md bg-black' /></div>

                        <div><input type='password' placeholder='Password' className='p-2 border border-grey-500 rounded-md bg-black' /></div>
                        <div> <input type="password" placeholder='Re-enter Password' className={`${type === "login" ? "hidden" : "block p-2 border border-grey-500 rounded-md bg-black"}`} /></div>
                    </div>
