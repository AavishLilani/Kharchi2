    ...
    return (
        <div className='flex justify-center items-center h-screen bg-black text-gray-500 '>
            <div>
                ...
                <form action="#" className='flex flex-col gap-3 w-full items-center p-10 bg-black border border-gray-500 box-md mb-5 shadow-gray-300 shadow '>
                    {/* <FloatingLabelInput
                        id="expense-input"
                        label="Enter Expense"
                        type='password'
                    ...
                    <div className='flex flex-col gap-5 items-center '>
                        <div>
                            <input type="text" placeholder='Name' className={`${type === "login" ? "hidden" : "block p-2 border border-grey-500 rounded-md bg-black"}`} />
                        </div>
                        <div>
